...
> [!IMPORTANT]
> The Hyperscale service tier is currently in public preview. We don't recommend running any production workload in Hyperscale databases yet. You can't update a Hyperscale database to other service tiers. For test purposes, we recommend you make a copy of your current database, and update the copy to the Hyperscale service tier.
